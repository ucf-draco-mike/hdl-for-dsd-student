    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        baseShellHook = localeHook + ''
          ...
          echo ""
          echo "  ── Student tools (run from the repo root) ──────────"
          echo "    scripts/lab_submit.sh <day> bundle your work into a hand-in zip"
          echo "    (add -h/--help to either for details)"
          echo ""
          echo "  ── Working a lab (run from a labs/weekN_dayNN dir) ──"
          echo "    make ex1            build exercise 1 (starter)"
          echo "    make ex1_sim        simulate exercise 1"
          echo "    make ex1_wave       open the waveform in GTKWave"
          echo "    make ex1 SOLUTION=1 build the solution instead of the starter"
          echo "    make clean          remove generated build artifacts"
          echo ""
          echo "  More guides & cheatsheets: https://hdl4dsd.com/references/"
