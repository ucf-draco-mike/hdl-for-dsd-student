...
module tb_shift_reg_sipo;
    ...
    initial begin
        ...
        expected[2] = 8'b00000101;
        expected[3] = 8'b00001011;
        expected[4] = 8'b00010110;
        expected[5] = 8'b00101100;
        expected[6] = 8'b01011001;
        expected[7] = 8'b10110010;
    end
    ...
    initial begin
        ...
        for (i = 0; i < 8; i = i + 1) begin
            ...
            if (parallel_out !== expected[i]) begin
                $display("FAIL: expected par=%08b, got par=%08b", expected[i], parallel_out);
