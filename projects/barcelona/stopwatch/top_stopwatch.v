// =============================================================================
// top_stopwatch.v — Board wiring for the Stopwatch (Barcelona Final Project)
// =============================================================================
// Nandland Go Board I/O:
//   SW1 = start/stop toggle      SW4 = reset (clear to 00)
//   LED1 = running indicator     LED4 = heartbeat
//   7-seg display 1 = seconds tens digit   display 2 = seconds ones digit
//
// This top is COMPLETE — your design work is in stopwatch.v.
// =============================================================================
module top_stopwatch (
    ...
    stopwatch u_sw (
        .i_clk(i_clk), .i_rst(w_db4), .i_run_toggle(w_toggle),
        .o_running(w_running), .o_tens(w_tens), .o_ones(w_ones)
    );
