...
> **Barcelona edition?** Start with the ready-to-build, team-friendly scaffolds
> in [`barcelona/`](barcelona/) — each is a self-contained directory with a
> spec sheet, an FSM scaffold that drives both 7-seg displays, a runnable
> testbench, and a verification plan. Project brief and rubric:
> <https://hdl4dsd.com/barcelona-project/>.
